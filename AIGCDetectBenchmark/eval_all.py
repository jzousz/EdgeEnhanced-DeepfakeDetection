...
for v_id, val in enumerate(vals):
    ...
    acc, ap, r_acc, f_acc, y_true, y_pred, auroc = validate(model, opt)
    rows.append([val, acc, ap, r_acc, f_acc,auroc])
    print("({}) acc: {}; ap: {};  r_acc: {}, f_acc: {}, auroc: {}".format(val, acc, ap, r_acc, f_acc,auroc))
